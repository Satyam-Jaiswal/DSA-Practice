...
private
      static boolean process(int nodeWithMaxDepth, int[] parent, int[] level, int[] query, int[] visited, int marker)
      {
...
private
      static void visitTillParent(int nodeWithMaxDepth, int[] parent, int[] visited, int marker)
      {
            visited[nodeWithMaxDepth] = marker;
...
private
      static void preProcess(Map<Integer, Set<Integer>> tree, int[] level, int[] parent)
      {
...
private
      static void addPath(Map<Integer, Set<Integer>> tree, Integer u, Integer v)
      {
            addEdge(tree, u, v);
            addEdge(tree, v, u);
      }
...
private
      static void addEdge(Map<Integer, Set<Integer>> tree, Integer u, Integer v)
      {
